function chessButton() {
	...
	document.getElementById('clubDiv').style.backgroundImage = "url('chess.jpeg')"
...
function computerButton() {
	...
	document.getElementById('clubDiv').style.backgroundImage = "url('computer.jpg')"
...
function dndButton() {
	...
	document.getElementById('clubDiv').style.backgroundImage = "url('dnd1.jpg')"
...
function helpingHandsButton() {
	...
	document.getElementById('clubDiv').style.backgroundImage = "url('hh.jpg')"
...
function pingPongButton() {
	...
	document.getElementById('clubDiv').style.backgroundImage = "url('pp.jpg')"
